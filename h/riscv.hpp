...
public:
    ...
    //funkcije za alokaciju i dealokaciju memorije za potrebe kernela
    static void* kmem_alloc(size_t size); //size - broj blokova za alokaciju
    static int kmem_free(void* p);

    // pop sstatus.spp and sstatus.spie bits (has to be a non inline function)
    // mode - 0 for user thread, 1 for kernel thread
    static void popSppSpie(int mode);
    ...
    //rutina na koju se prelazi prilikom pojave prekida ili izuzetka
